...
type StringIteratorStream interface {
	Send(*datatypes.TagsResponse) error
}

type StringIteratorWriter struct {
	stream StringIteratorStream
	res    *datatypes.TagsResponse
	err    error
...
func NewStringIteratorWriter(stream StringIteratorStream, hints datatypes.HintFlags) *StringIteratorWriter {
